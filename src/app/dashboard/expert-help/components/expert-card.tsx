...
export function ExpertCard({ expert }: ExpertCardProps) {
  ...
  return (
    <Card className="flex flex-col overflow-hidden rounded-xl transition-shadow hover:shadow-lg">
      <CardHeader className="items-center bg-muted/50 p-6">
        ...
        <div className="text-center">
            <h3 className="mt-4 text-xl font-bold">{expert.name}</h3>
            <p className="text-sm text-primary">{expert.role}</p>
        </div>
      </CardHeader>
      <CardContent className="flex-1 p-6">
        <h4 className="mb-4 font-semibold">Core Competencies</h4>
